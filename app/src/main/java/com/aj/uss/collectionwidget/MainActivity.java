...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = getIntent().getStringExtra(CollectionWidget.EXTRA_LABEL);


        editName = findViewById(R.id.editText);
        editDept = findViewById(R.id.editText2);
        editRegId = findViewById(R.id.editText3);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dept = editDept.getEditableText().toString();
                regId = editRegId.getEditableText().toString();
                ...
                Uri STUDENTS_URI = Uri.parse(URL);
